...
import { DeleteMapPointsDto } from "../dtos/DeleteMapPointsDto";
import NotAllowedActionError from "../errors/NotAllowedActionError";

export default class DeleteMapPoints {
    constructor(
    ...
    async exec(
        ...
        await this.mapRepository.deleteMapPoints(mapId, data.pointIds);
    }
}
